  ...
  $(function(){
	...
	//textarea 자동 크기 증가
	  ...
	  $('form').on('submit',function(){
		  ...
		  if('${board.notice_title}'==$('#title').val())
			  $('#title').val(null);
...
<body>
  ...
  <table class="boardContainer">
    ...
    <tr>
      <td colspan="4"><input type="text" name="title" id="title" placeholder="제목을 입력해주세요" value="${ board.notice_title }"/></td>
    </tr>
    <tr>
      <th>게시자</th>
    ...
    <tr>
      ...
      <img id="noticeImg" alt="[ 이미지 선택 ]" src="${ board.notice_image }"/></td>
    </tr>
    <tr>
      <td colspan="4" class="contTd"><textarea name="cont" id="cont">${ board.notice_cont }</textarea></td>
    </tr>
    <tr>
