...
<style>
 ...
 .searchbar input { width:400px; height:30px; margin-right:10px; }
 ...
 td:nth-of-type(4) a { text-decoration: none; color:orange; }
 th a,td a { text-decoration: none; color:orange; }
 td:nth-of-type(2), th:nth-of-type(2) { width:50px;}
 th:nth-of-type(3) { width:100px;}
 td:nth-of-type(3) { width:100px; height:100px;}
 td:nth-of-type(4), th:nth-of-type(4) { width:500px;}
 td:nth-of-type(5), th:nth-of-type(5) { width:150px;}
 td:nth-of-type(6), th:nth-of-type(6) { width:100px;}
 td:nth-of-type(7), th:nth-of-type(7) { width:100px;}
 td:nth-of-type(8), th:nth-of-type(8) { width:150px;}
...
<script>
   $(function(){
	   ...
	   switch('${option}'){
	       ...
	       case 'bookTitle': $(option[3]).prop('selected',true); break;
	       case 'writer': $(option[4]).prop('selected',true); break;
	   }
	   	
	   if('${keyword}' != ''){
		   $('#bWrite').css('margin-left','32%');
	   }
	   ...
	   $('#bWrite').on('click',function(){
		   ...
		   location.href="/BBoard/WriteForm";
	   })//글쓰기 끝
	   ...
	   $('#search').on('click',function(){
		   ...
		   switch(option){
		   		...
		   		case '책 제목'	      :  var option = 'bookTitle'; break;
		   		case '저자'		  :  var option = 'writer'; break;
		   }
		   location.href='/BBoard/page/1?keyword='+$('#keyword').val()+'&option='+option;
	   })
	   ...
	   //페이징 버튼 클릭 시  검색어 존재 시 검색어 포함(검색 조건 포함)
	   console.log('${writer}');
	   var keyword= '${keyword}';
	   ...
	   $('#delete').on('click',e=>{
		   if(confirm('선택한 게시물을 삭제하시겠습니까?')){
			   ...
			   let json = {board_num_list:arr};
			   
			   $.ajax({
				   url:'/BBoard/DeleteAjax',
  ...
  <div class="searchbar">
    ...
    <table>
      ...
      <tr>
        ...
        <td><img src="${ board.book_image }" alt="이미지 없음"/></td>
        <td>[&nbsp;${ board.book_title }&nbsp;]<br/>
        <b><a href="/BBoard/View/page/${ nowpage }/bno/${board.board_num}">${ board.board_title }</a></b>&nbsp;[ ${ board.replycount } ]
        </td>
        <td><a href="/BBoard/page/1?writer=${board.board_writer}">${ board.board_writer }</a></td>
      ...
      <tr>
        <td colspan="7"><b>검색된 자료가 없습니다</b></td>
      </tr>
      </c:if>
    ...
    <c:set  var="href"  value="/BBoard/page/"/>
